...
<body>
  ...
  <form method="post" action="login.php">
    ...
    <p>
     New member? <a href="register.php" style="text-decoration: none;color: rgba(255, 99, 71, 0.9);
">Sign up</a>
    </p>
  </form>
...
if (isset($_POST['submit'])) {
  ...
  if(!$error)
  {
    ...
    if (($user['email'] === $email) AND ($user['password'] === $password)) {
      ...
      echo "<script>alert('Sucessfully logged in');window.location = 'menu.php';</script>";
